...
int scd_ls_update(subview_col<double> Hj, const mat & WtW, vec & mu, const subview_col<uword> mask, const int & max_iter, const double & rel_tol)
{
	// Problem:  Aj = W * Hj
...
int scd_kl_update(subview_col<double> Hj, const mat & Wt, const vec & Aj, const vec & sumW, const subview_col<uword> mask,
	const vec & beta, const int & max_iter, const double & rel_tol)
{
	// Problem:  Aj = W * Hj
