---
title: "NNLM: a package for fast and versatile non-negative matrix factorization"
...
```{r rank-sim, fig.width = 5, fig.height = 5, fig.align = 'center'}
set.seed(678);
...
```{r rank-nsclc, fig.width = 5, fig.height = 5, fig.align = 'center'}
set.seed(567);
